      ...
      <main className="flex flex-col gap-6 row-start-2 items-center w-full">
        <div className="flex flex-col gap-6 row-start-2 items-center w-full">
          <div className="flex flex-col lg:flex-row justify-center gap-4 w-full max-w-4xl">
            {/* Profile Card */}
            <div className="flex flex-col items-center justify-center text-center bg-surface0 text-text p-4 sm:p-6 rounded-lg shadow-md w-full border border-lavender/10">
              <div className="flex flex-col items-center space-y-4 justify-center w-full">
                <div className="p-2 rounded text-center items-center w-full">
                  <div className="mb-4 flex flex-col sm:flex-row items-center justify-center">
                    <Image
                      className="w-20 h-20 sm:w-24 sm:h-24 rounded-full shadow-lg border border-solid border-overlay0 mb-3 sm:mb-0 sm:mr-4"
                      src="/assets/pfp.png"
                      alt="pfp"
                      width={128}
                      height={128}
                    ...
                    <div className="flex flex-col items-center sm:items-start">
                      ...
                      <span className="bg-lavender text-base text-xs font-medium px-2.5 py-0.5 rounded-lg">
                        she/they 🏳️‍⚧️
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="text-center items-center">
                    <div className="text-left items-start">
                      <span className="bg-blue text-base text-xs font-medium px-2.5 py-0.5 rounded-lg">
                        About Me:
                      </span>
                      <p className="mb-3"></p>
                    </div>
                    <div className="text-left">
                      ...
                      <p className="mb-4"></p>
                      <div className="text-left items-start">
                        <span className="bg-green text-base text-xs font-medium px-2.5 py-0.5 rounded-lg">
                      ...
                      <p className="text-sm">
                        <a className="text-blue hover:text-sky" href="https://github.com/notmycode-labs">notmycode-labs</a> and <a className="text-blue hover:text-sky" href="https://github.com/osu-somtum">osu!somtum</a>
                      </p>
                      <p className="mb-4"></p>
                    </div>
                    <div>
                    ...
                    <div className="mb-4 text-center flex gap-3 items-center justify-center flex-col sm:flex-row">
                      <a
                        className="no-underline bg-surface1 rounded-lg border border-lavender/10 transition-colors duration-300 hover:bg-surface2 inline-flex h-10 px-6 items-center text-sm font-medium text-center text-text gap-2 w-full sm:w-auto"
                    ...
                    <a className="text-sm text-subtext0">
            ...
            {/* Social Media Card */}
            <div className="bg-surface0 text-text p-4 sm:p-6 rounded-lg shadow-md w-full border border-lavender/10">
              <div className="flex flex-col justify-center items-center gap-4 text-center">
                <span className="bg-lavender text-base text-lg font-medium px-2.5 py-0.5 rounded-lg">Social Media</span>
                <p className="mb-2 text-sm">Stalk me on the internet with these socials</p>
                <div className="grid grid-cols-2 gap-3 w-full">
                  <a
                    className="no-underline bg-surface1 rounded-lg border border-lavender/10 transition-colors duration-300 hover:bg-surface2 inline-flex h-10 px-4 items-center justify-center gap-2"
                    href="https://matrix.to/#/@mushroomcandela:matrix.org"
                    rel="noopener noreferrer"
                  >
                ...
                <span className="mt-4 bg-peach text-base text-lg font-medium px-2.5 py-0.5 rounded-lg mb-4">Github Statistics</span>
                <div className="w-full flex flex-col items-center justify-center gap-4">
                  ...
                  >
                    <img 
                      ...
                      src="https://github-readme-stats-eight-theta.vercel.app/api?username=lovelytransgirl&theme=dracula" 
                      alt="GitHub statistics"
                    />
                  </a>
                  <a className="text-sm text-subtext0">(I only use github on private repository so yeah)</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-surface0 text-text p-4 sm:p-6 rounded-lg shadow-md w-full max-w-4xl border border-lavender/10">
            <div className="w-full flex flex-col items-center justify-center gap-4">
              <span className="bg-blue text-base text-lg font-medium px-2.5 py-0.5 rounded-lg">
                Skills & Technologies
              </span>

              {/* Languages Section */}
              <div className="w-full">
                <span className="text-lavender text-sm font-medium">Programming Languages</span>
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-2">
                  <div className="flex flex-col justify-between bg-surface1 p-4 rounded-lg">
                    ...
                    <div className="w-full bg-surface2 rounded-full h-2">
                      <div className="bg-lavender h-2 rounded-full" style={{ width: '76%' }}></div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col justify-between bg-surface1 p-4 rounded-lg">
                    ...
                    <div className="w-full bg-surface2 rounded-full h-2">
                      <div className="bg-lavender h-2 rounded-full" style={{ width: '38%' }}></div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col justify-between bg-surface1 p-4 rounded-lg">
                    ...
                    <div className="w-full bg-surface2 rounded-full h-2">
                      <div className="bg-lavender h-2 rounded-full" style={{ width: '20%' }}></div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col justify-between bg-surface1 p-4 rounded-lg">
                    ...
                    <div className="w-full bg-surface2 rounded-full h-2">
                      <div className="bg-lavender h-2 rounded-full" style={{ width: '2%' }}></div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col justify-between bg-surface1 p-4 rounded-lg">
                    ...
                    <div className="w-full bg-surface2 rounded-full h-2">
                      <div className="bg-lavender h-2 rounded-full" style={{ width: '25%' }}></div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col justify-between bg-surface1 p-4 rounded-lg">
                    ...
                    <div className="w-full bg-surface2 rounded-full h-2">
                      <div className="bg-lavender h-2 rounded-full" style={{ width: '13%' }}></div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col justify-between bg-surface1 p-4 rounded-lg">
                    ...
                    <div className="w-full bg-surface2 rounded-full h-2">
                      <div className="bg-lavender h-2 rounded-full" style={{ width: '10%' }}></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Frameworks Section */}
              <div className="w-full">
                <span className="text-green text-sm font-medium">Frameworks & Libraries</span>
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-2">
                  <div className="flex flex-col justify-between bg-surface1 p-4 rounded-lg">
                    <div className="flex items-center gap-2 mb-4">
              ...
              {/* Tools Section */}
              <div className="w-full">
                <span className="text-peach text-sm font-medium">Tools & Platforms</span>
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-2">
                  <div className="flex items-center gap-2 bg-surface1 p-4 rounded-lg">
